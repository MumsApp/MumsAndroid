...
class FragmentsNavigationService {
    ...
    fun openUserProfileFragment(userId: Int, addToBackStack: Boolean) {
        val fragment = createUserProfileFragment(userId)
        openFragment(fragment, addToBackStack)
    }

    fun createUserProfileFragment(userId: Int) = UserProfileFragment.getInstance(userId)
    ...
    fun openLobbyTopicDetailsFragment(lobbyRoom: LobbyRoom, lobbyRoomTopic: LobbyRoomTopic, addToBackStack: Boolean) {
        val fragment = createLobbyTopicDetailsFragment(lobbyRoom, lobbyRoomTopic)
        openFragment(fragment, addToBackStack)
    }

    fun createLobbyTopicDetailsFragment(lobbyRoom: LobbyRoom, lobbyTopic: LobbyRoomTopic) = LobbyTopicDetailsFragment.getInstance(lobbyRoom, lobbyTopic)

    fun openCreateLobbyTopicPostFragment(lobbyRoom: LobbyRoom, lobbyTopic: LobbyRoomTopic, addToBackStack: Boolean) {
        val fragment = createCreateLobbyTopicPostFragment(lobbyRoom, lobbyTopic)
        openFragment(fragment, addToBackStack)
    }
