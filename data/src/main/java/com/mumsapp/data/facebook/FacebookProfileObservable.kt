...
class FacebookProfileObservable(private val accessToken: AccessToken) : Observable<FacebookUserResponse>() {


    override fun subscribeActual(observer: Observer<in FacebookUserResponse>?) {
        val params = Bundle()
